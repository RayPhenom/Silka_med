    ...
    return (
        <div className="fixed w-full z-10 text-white">
            <div>
                ...
                <div
                    className={
                        '${menu ? "translate-x-0" : "-translate-x-full"} lg:hidden flex  flex-col absolute bg-backgroundColor text-white left-0 top-16 font-semibold text-2xl  tect-center pt-8 pb-4 gap-8 w-full h-fit transition-transform duration-300'
                    }
                >
                    <Link
                        to="home"
