  ...
  return (
    <div className="group flex flex-col items-center text-center gap-2 w-full lg:w-1/3 p-5 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] rounded-lg cursor-pointer lg:hover:-translate-y-6 transition duration-300 ease-in-out">
      ...
      <p>
        ...
        cupiditate distinctio omnis iste modi quis! A voluptate aliquid,
        repudiandae eos doloremque, perferendis ea placeat similique dignissimos
        architecto sed quod commodi.Lorem ipsum dolor sit amet, consectetur adipisicing elit. Officiis
        cupiditate distinctio omnis iste modi quis! A voluptate aliquid,
        repudiandae eos doloremque, perferendis ea placeat similique dignissimos
        architecto sed quod commodi.
      </p>
